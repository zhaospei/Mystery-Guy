...
Character::Character(int p_x, int p_y){
    mBox.x = p_x;
    mBox.y = p_y;
    mBox.w = CHA_WIDTH;
    mBox.h = CHA_HEIGHT;
...
void Character::render(SDL_Rect& camera, SDL_Renderer*& gRenderer){
	gChaTexture.render(mBox.x - camera.x, mBox.y - camera.y, gRenderer);
}